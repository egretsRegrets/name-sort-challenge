...
var sampleInput = ['Nick', 'jake', 'RAY', 'Kate', 'Nick', 'Jeremy', 'Ryan', 'nick', 'AMOL', 'rAY', 'VIANNEY', 'Samuel', 'ryan', 'Shilpika', 'nick', 'THOMAS', 'tom', 'james', 'JERM', 'amOl', 'kate', 'SCOTT', 'Jenifer', 'bill', 'jenny', 'STEVEN'];

var expectedOutput = ['bill', 'jake', 'james', 'jenifer', 'jenny', 'jeremy', 'jerm', 'samuel', 'scott', 'shilpika', 'steven', 'thomas', 'tom', 'vianney'];
...
function uniqueNamesFromCollection(collection) {
   ...
   */
  var alphaSortedNames = uniqueNames.sort(
  /**
...
var sortedNames = uniqueNamesFromCollection(sampleInput);
